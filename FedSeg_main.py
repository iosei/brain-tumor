...
def train_val_3unet():
    ...
    for rnd in range(number_of_rounds):
        ...
        df.to_csv("Fed_training.csv", index=False)
        ...
        torch.save(global_model.net.state_dict(),
                   f"last_fround_model.pth")
    ...
    fig.savefig("fed_result1.png", format="png", pad_inches=0.2, transparent=False, bbox_inches='tight')
    fig.savefig("fed_result1.svg", format="svg", pad_inches=0.2, transparent=False, bbox_inches='tight')
