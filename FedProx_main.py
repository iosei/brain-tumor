...
class GlobalConfig:
    ...
    pretrained_model_path = 'C://Users//NEW//Desktop//FedTumor//FedTumor//BRATS//Data//Brats2020//brats2020logs//brats2020logs//fedprox//last_epoch_model.pth'
...
def train_val_3unet():
    ...
    for rnd in range(number_of_rounds):
        ...
        round_dice_list = []
        round_iou_list = []
        print("FedProx training for round ",str(rnd + 1))
        ...
        clients_init_params, w_glob= FedProx(copy.deepcopy(clients_init_params), copy.deepcopy(global_model.state_dict()))
        ...
        df.to_csv("FedProx_training.csv", index=False)
        ...
        torch.save(global_model.state_dict(),
                   f"last_FedProx_round_model.pth")
    ...
    fig.savefig("fedProx_result1.png", format="png", pad_inches=0.2, transparent=False, bbox_inches='tight')
    fig.savefig("fedProx_result1.svg", format="svg", pad_inches=0.2, transparent=False, bbox_inches='tight')
    ...
    title = "Ground Truth_fedProx" + id_[0]
    ...
    title = "Prediction_fedProx" + id_[0]
