...
class Trainer:
    def __init__(self,
        ...
        """Initialization with Differential Privacy (DP) using Opacus."""
    ...
    def _do_epoch(self, epoch: int, phase: str):
        ...
        for itr, data_batch in enumerate(dataloader):
            ...
            with torch.set_grad_enabled(phase == "train"):
                ...
                if phase == "train":
                    ...
                    if (itr + 1) % self.accumulation_steps == 0 or itr == len(dataloader) - 1:
                        self.optimizer.step()  # Update weights after accumulated gradients
                        self.optimizer.zero_grad()  # Zero gradients for next iteration
        ...
        self.accuracy_scores[phase].append(epoch_accuracy)
