...
class GlobalConfig:
    ...
    pretrained_model_path = 'C://Users//NEW//Desktop//FedTumor//FedTumor//BRATS//Data//Brats2020//BraTS2020_TrainingData//brats2020logs//last_epoch_model.pth'
    train_logs_path = 'C://Users//NEW//Desktop//FedTumor//FedTumor//BRATS//Data//Brats2020//BraTS2020_TrainingData//brats2020logs//train_log.csv'
    ae_pretrained_model_path = 'C://Users//NEW//Desktop//FedTumor//FedTumor//BRATS//Data//Brats2020//BraTS2020_TrainingData//brats2020logs//autoencoder_best_model.pth'
    tab_data = 'C://Users//NEW//Desktop//FedTumor//FedTumor//BRATS//Data//Brats2020//BraTS2020_TrainingData//brats2020logs//df_with_voxel_stats_and_latent_features.csv'
    seed = 55
...
class ViTBlock(nn.Module):
    def __init__(self, in_channels, out_channels, img_size=224):
        ...
        self.vit_model = timm.create_model('vit_base_patch16_224', pretrained=False)
        self.vit_model.head = nn.Identity()  # Remove the classification head

        # Adjust the number of input channels for the convolutional layer
        self.conv1x1 = nn.Conv3d(9, out_channels, kernel_size=1)  # Update this line
    ...
    def forward(self, x):
        ...
        # Apply the 2D Vision Transformer to each slice
        x = F.interpolate(x, size=(224, 224), mode='bilinear', align_corners=False)
        x = self.adjust_channels(x)
        x = self.vit_model(x)

        # Reshape back to original dimensions
        x = x.view(b, -1, 8, 12, 8)  # -1 for the new channel dimension
...
class UNet3d(nn.Module):
    def __init__(self, in_channels, n_classes, n_channels):
        ...
        # ViTBlock instance
        self.vit_transformer = ViTBlock(8 * n_channels, 8 * n_channels)
    ...
    def forward(self, x):
        ...
        # Apply ViTBlock
        vit = self.vit_transformer(x5)

        mask = self.dec1(vit, x4)
