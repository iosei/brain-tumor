...
def save_labels(model, dataloader, save_path):
    ...
    subject_ignore = ["BraTS20_Validation_067", "BraTS20_Validation_068", "BraTS20_Validation_069",
                      "BraTS20_Validation_070", "BraTS20_Validation_072", "BraTS20_Validation_074",
                      "BraTS20_Validation_075", "BraTS20_Validation_076", "BraTS20_Validation_077",
                      "BraTS20_Validation_078", "BraTS20_Validation_082", "BraTS20_Validation_083",
                      "BraTS20_Validation_084", "BraTS20_Validation_085", "BraTS20_Validation_087",
                      "BraTS20_Validation_089", "BraTS20_Validation_090", "BraTS20_Validation_088",
                      "BraTS20_Validation_091",  "BraTS20_Validation_092","BraTS20_Validation_095",
                      "BraTS20_Validation_096", "BraTS20_Validation_097", "BraTS20_Validation_098",
                      "BraTS20_Validation_099", "BraTS20_Validation_102", "BraTS20_Validation_103",
                      "BraTS20_Validation_104", "BraTS20_Validation_107", "BraTS20_Validation_109"]
    ...
    with torch.no_grad():
        ...
        for i, data in enumerate(dataloader):
            ...
            #if str(data['Id'][0]) in subject_ignore:
                #continue

            imgs = imgs.to(device)
            logits = model(imgs)
            logits = torch.sigmoid(logits)
            logits = (logits >= 0.33).float()
            logits = logits.detach().cpu().numpy()
            ...
            mask = np.moveaxis(mask, (0, 1, 2, 3, 4), (0, 1, 4, 3, 2))
            ...
            for sh in range(shapes):
                sds = max(directed_hausdorff(wt[:,:,sh], t_wt[:,:,sh])[0], directed_hausdorff(t_wt[:,:,sh], wt[:,:,sh])[0])
                list_save.append(sds)

            print("All", sum(list_save),shapes)
...
def evaluate_trained_model():
    ...
    save_labels(global_model, val_dataloader, "/home/zengsn/BRATS/Data/SegmentationLabels/FedProx/")
